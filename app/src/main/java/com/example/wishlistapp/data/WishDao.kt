...
abstract class WishDao {
    ...
    abstract suspend fun addWish(wishEntity: Wish) // it don't need {} or content beacause it is a abstract --> we're saying that whoever wants to call addWish method needs to actually do the  implementation
